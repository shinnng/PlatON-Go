...
import network.platon.contracts.evm.v0_6_12.BasicDataTypeConstantContract;
...
public class BasicDataTypeConstantAddressTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "BasicDataTypeConstantContractTest.合约地址Address常量",sourcePrefix = "evm/0.6.12")
