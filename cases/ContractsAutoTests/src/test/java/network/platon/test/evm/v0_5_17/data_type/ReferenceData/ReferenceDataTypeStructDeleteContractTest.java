...
import network.platon.contracts.evm.v0_5_17.ReferenceDataTypeStructDeleteContract;
...
public class ReferenceDataTypeStructDeleteContractTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "ReferenceDataTypeStructDelete.结构体嵌套delete操作",sourcePrefix = "evm/0.5.17")
