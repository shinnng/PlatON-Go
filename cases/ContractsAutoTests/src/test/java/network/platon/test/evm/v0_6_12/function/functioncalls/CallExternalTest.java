package network.platon.test.evm.v0_6_12.function.functioncalls;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_6_12.CallExternal;
...
public class CallExternalTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.CallExternalTest-函数外部调用测试", sourcePrefix = "evm/0.6.12")
