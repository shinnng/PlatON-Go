...
import network.platon.contracts.evm.v0_6_12.ReferenceDataTypeArrayContract;
...
public class ReferenceDataTypeArrayMethodTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "ReferenceDataTypeMultiArrayContractTest.数组（Array）方法",sourcePrefix = "evm/0.6.12")
