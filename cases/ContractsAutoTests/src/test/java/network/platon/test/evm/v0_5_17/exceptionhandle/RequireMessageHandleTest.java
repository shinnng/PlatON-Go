package network.platon.test.evm.v0_5_17.exceptionhandle;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import com.platon.protocol.exceptions.TransactionException;
import network.platon.contracts.evm.v0_5_17.RequireMessageHandle;
...
public class RequireMessageHandleTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "albedo", showName = "exceptionhandle.RequireMessageHandle-require(bool condition, string message)函数", sourcePrefix = "evm/0.5.17")
