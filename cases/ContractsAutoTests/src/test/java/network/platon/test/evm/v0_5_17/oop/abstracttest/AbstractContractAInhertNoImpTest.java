...
import network.platon.contracts.evm.v0_5_17.AbstractContractSon;
...
public class AbstractContractAInhertNoImpTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约被继承未实现执行情况",sourcePrefix = "evm/0.5.17")
