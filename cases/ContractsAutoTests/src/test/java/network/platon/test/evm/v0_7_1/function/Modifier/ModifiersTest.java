package network.platon.test.evm.v0_7_1.function.Modifier;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_7_1.Modifiers;
...
public class ModifiersTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.ModifiersTest-多修饰器函数测试", sourcePrefix = "evm/0.7.1")
