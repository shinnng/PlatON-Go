...
import network.platon.contracts.evm.v0_5_17.AssemblyReturns;
...
public class AssemblyReturnsTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.AssemblyReturnsTest-AssemblyReturns测试", sourcePrefix = "evm/0.5.17")
