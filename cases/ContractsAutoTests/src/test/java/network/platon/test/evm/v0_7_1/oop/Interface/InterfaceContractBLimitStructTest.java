...
import network.platon.contracts.evm.v0_7_1.InterfaceContractStructTest;
...
public class InterfaceContractBLimitStructTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "InterfaceContractLimitStruct.验证接口定义结构体", sourcePrefix = "evm/0.7.1")
