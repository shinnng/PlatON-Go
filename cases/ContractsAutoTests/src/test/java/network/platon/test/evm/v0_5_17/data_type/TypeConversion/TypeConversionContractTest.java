...
import network.platon.contracts.evm.v0_5_17.TypeConversionContract;
...
public class TypeConversionContractTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "TypeConversionContract.基本类型转换",sourcePrefix = "evm/0.5.17")
