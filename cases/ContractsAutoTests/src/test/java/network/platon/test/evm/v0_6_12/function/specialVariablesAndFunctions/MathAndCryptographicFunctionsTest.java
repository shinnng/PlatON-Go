...
import network.platon.contracts.evm.v0_6_12.MathAndCryptographicFunctions;
...
public class MathAndCryptographicFunctionsTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.MathAndCryptographicFunctionsTest-数学和加密函数测试", sourcePrefix = "evm/0.6.12")
