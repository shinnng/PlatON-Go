...
import network.platon.contracts.evm.v0_5_17.InterfaceContractEnumTest;
...
public class InterfaceContractBLimitEnumTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "InterfaceContractLimitEnum.验证接口中定义枚举",sourcePrefix = "evm/0.5.17")
