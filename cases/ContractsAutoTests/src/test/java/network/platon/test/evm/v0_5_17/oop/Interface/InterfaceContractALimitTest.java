...
import network.platon.contracts.evm.v0_5_17.InterfaceContractParentTest;
...
public class InterfaceContractALimitTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "InterfaceContract.接口的函数只能声明外部类型",sourcePrefix = "evm/0.5.17")
