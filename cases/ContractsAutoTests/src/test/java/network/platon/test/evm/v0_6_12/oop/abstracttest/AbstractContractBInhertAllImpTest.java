...
import network.platon.contracts.evm.v0_6_12.AbstractContractBSubclass;
...
public class AbstractContractBInhertAllImpTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约单继承且实现执行情况",sourcePrefix = "evm/0.6.12")
