...
import network.platon.contracts.evm.v0_6_12.AbstractContractGSubclass;
...
public class AbstractContractDInhertTest extends ContractPrepareTest {
   ...
   private String age,resultAge;
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约继承接口执行情况",sourcePrefix = "evm/0.6.12")
