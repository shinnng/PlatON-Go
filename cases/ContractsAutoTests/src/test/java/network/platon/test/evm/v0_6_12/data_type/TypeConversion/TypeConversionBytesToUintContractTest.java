package network.platon.test.evm.v0_6_12.data_type.TypeConversion;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_6_12.TypeConversionBytesToUintContract;
...
public class TypeConversionBytesToUintContractTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "TypeConversionContract.字节转换整型",sourcePrefix = "evm/0.6.12")
