...
import network.platon.contracts.evm.v0_5_17.ReferenceDataTypeStructContract;
...
public class ReferenceDataTypeStructContractTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "ReferenceDataTypeStructContractTest.结构体定义、赋值及取值",sourcePrefix = "evm/0.5.17")
