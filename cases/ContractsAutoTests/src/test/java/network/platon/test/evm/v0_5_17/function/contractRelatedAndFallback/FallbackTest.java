package network.platon.test.evm.v0_5_17.function.contractRelatedAndFallback;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_5_17.FallBack;
...
public class FallbackTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "liweic", showName = "function.FallbackTest-this和回退函数测试", sourcePrefix = "evm/0.5.17")
