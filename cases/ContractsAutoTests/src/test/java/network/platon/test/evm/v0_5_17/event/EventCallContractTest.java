...
import network.platon.contracts.evm.v0_5_17.EventCallContract;
...
public class EventCallContractTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "emitEvent",
            author = "albedo", showName = "event.EventCallContractTest-event关键字声明事件", sourcePrefix = "evm/0.5.17")
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "indexedEvent",
            author = "albedo", showName = "event.EventCallContractTest-indexed关键字定义事件索引", sourcePrefix = "evm/0.5.17")
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "anonymousEvent",
            author = "albedo", showName = "event.EventCallContractTest-anonymous关键字定义匿名事件", sourcePrefix = "evm/0.5.17")
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "testEmitEvents",
            author = "albedo", showName = "event.EventCallContractTest-函数多事件监听", sourcePrefix = "evm/0.5.17")
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "testMultiAnonymousEvents",
            author = "albedo", showName = "event.EventCallContractTest-函数多匿名事件监听", sourcePrefix = "evm/0.5.17")
