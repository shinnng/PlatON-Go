package network.platon.test.evm.v0_5_17.data_type.structs;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_5_17.RecursiveStorageMemoryComplex;
...
public class RecursiveStorageMemoryComplexTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls",sheetName = "structs", author = "hudenian", showName = "StructDataTypeTest.结构体数据类型",sourcePrefix = "evm/0.5.17")
