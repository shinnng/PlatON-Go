package network.platon.test.evm.v0_6_12.oop.inherit;

import com.platon.protocol.core.methods.response.TransactionReceipt;
import network.platon.contracts.evm.v0_6_12.InheritContractASub;
import network.platon.contracts.evm.v0_6_12.InheritContractBSub;
...
public class InheritContractPassParamTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "InheritContract.合约继承支持传参",sourcePrefix = "evm/0.6.12")
