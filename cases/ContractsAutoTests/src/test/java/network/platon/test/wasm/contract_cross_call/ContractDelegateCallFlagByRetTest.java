...
public class ContractDelegateCallFlagByRetTest extends WASMContractPrepareTest {

    // 跨合约调用有返回值的合约
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "xujiacan", showName = "wasm.contract_delegate_call_flag_ByRet",sourcePrefix = "wasm")
    public void testCrossCallContractByRet() {
        ...
        try {
            ...
            collector.logStepPass("delegate_caller_byret deployed sucessfully, contractAddress:" + callerAddr + ", txHash:" + callerTxHash);


            // 给予receiver的gas足够时
            TransactionReceipt receipt = caller.callFeed(receiverAddr, Uint64.of(98651l)).send();
            collector.logStepPass("delegate_caller_byret callFeed by gas 98651l successfully txHash:" + receipt.getTransactionHash());
            ...
            collector.logStepPass("delegate_caller_byret callFeed by gas 10000 successfully txHash:" + receipt.getTransactionHash());
            ...
            collector.logStepPass("delegate_caller_byret callFeed by gas 0 successfully txHash:" + receipt.getTransactionHash());
            ...
            collector.logStepFail("Failed to call delegate_caller_byret Contract,exception msg:" , e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "xujiacan", showName = "wasm.contract_delegate_call_flag_ByNoRet",sourcePrefix = "wasm")
    public void testCrossCallContractByNoRet() {
        ...
        try {
            ...
            String callerAddr = caller.getContractAddress();
            String callerTxHash = caller.getTransactionReceipt().get().getTransactionHash();
            collector.logStepPass("delegate_caller_noret deployed sucessfully, contractAddress:" + callerAddr + ", txHash:" + callerTxHash);


            // 给予receiver的gas足够时
            TransactionReceipt receipt = caller.callFeed(receiverAddr, Uint64.of(98651l)).send();
            collector.logStepPass("delegate_caller_noret callFeed by gas 98651l successfully txHash:" + receipt.getTransactionHash());
            ...
            // 给予receiver的gas 不够时
            receipt = caller.callFeed(receiverAddr, Uint64.of(10000l)).send();
            collector.logStepPass("delegate_caller_noret callFeed by gas 10000 successfully txHash:" + receipt.getTransactionHash());
            ...
            // 直接给予 0gas, 就会使用默认的 剩余gas
            receipt = caller.callFeed(receiverAddr, Uint64.of(0l)).send();
            collector.logStepPass("delegate_caller_noret callFeed by gas 0 successfully txHash:" + receipt.getTransactionHash());
            ...
            collector.logStepFail("Failed to call delegate_caller_noret Contract,exception msg:" , e.getMessage());
            e.printStackTrace();
        }
    }
}
