...
public class FallbackDeclaraction extends Contract {
    ...
    protected FallbackDeclaraction(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    protected FallbackDeclaraction(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> existFunc(BigInteger para) {
        final Function function = new Function(
                FUNC_EXISTFUNC, 
                Arrays.<Type>asList(new com.platon.abi.solidity.datatypes.generated.Uint256(para)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<FallbackDeclaraction> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return deployRemoteCall(FallbackDeclaraction.class, web3j, credentials, contractGasProvider, BINARY,  "");
    }

    public static RemoteCall<FallbackDeclaraction> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return deployRemoteCall(FallbackDeclaraction.class, web3j, transactionManager, contractGasProvider, BINARY,  "");
    }

    public static FallbackDeclaraction load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return new FallbackDeclaraction(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static FallbackDeclaraction load(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return new FallbackDeclaraction(contractAddress, web3j, transactionManager, contractGasProvider);
    }
