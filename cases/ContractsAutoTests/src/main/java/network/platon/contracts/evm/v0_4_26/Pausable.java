...
public class Pausable extends Contract {
    ...
    protected Pausable(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    protected Pausable(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
    ...
    public static RemoteCall<Pausable> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return deployRemoteCall(Pausable.class, web3j, credentials, contractGasProvider, BINARY,  "");
    }

    public static RemoteCall<Pausable> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return deployRemoteCall(Pausable.class, web3j, transactionManager, contractGasProvider, BINARY,  "");
    }

    public static Pausable load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return new Pausable(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Pausable load(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
