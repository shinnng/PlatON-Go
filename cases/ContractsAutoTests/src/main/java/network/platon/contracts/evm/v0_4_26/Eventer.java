...
public class Eventer extends Contract {
    ...
    protected Eventer(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
    ...
    public static RemoteCall<Eventer> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return deployRemoteCall(Eventer.class, web3j, credentials, contractGasProvider, BINARY,  "");
    }

    public static RemoteCall<Eventer> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return deployRemoteCall(Eventer.class, web3j, transactionManager, contractGasProvider, BINARY,  "");
    }

    public static Eventer load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return new Eventer(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Eventer load(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return new Eventer(contractAddress, web3j, transactionManager, contractGasProvider);
    }
