...
public class StorageLocation extends Contract {
    ...
    protected StorageLocation(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    protected StorageLocation(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
    ...
    public static RemoteCall<StorageLocation> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return deployRemoteCall(StorageLocation.class, web3j, credentials, contractGasProvider, BINARY,  "");
    }

    public static RemoteCall<StorageLocation> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return deployRemoteCall(StorageLocation.class, web3j, transactionManager, contractGasProvider, BINARY,  "");
    }

    public static StorageLocation load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return new StorageLocation(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static StorageLocation load(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return new StorageLocation(contractAddress, web3j, transactionManager, contractGasProvider);
    }
}
