...
public class StandardToken extends Contract {
    ...
    protected StandardToken(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    protected StandardToken(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
    ...
    public static RemoteCall<StandardToken> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return deployRemoteCall(StandardToken.class, web3j, credentials, contractGasProvider, BINARY,  "");
    }

    public static RemoteCall<StandardToken> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
        return deployRemoteCall(StandardToken.class, web3j, transactionManager, contractGasProvider, BINARY,  "");
    }

    public static StandardToken load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider) {
        return new StandardToken(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static StandardToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider) {
